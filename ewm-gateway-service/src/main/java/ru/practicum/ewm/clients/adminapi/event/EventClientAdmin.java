package ru.practicum.ewm.clients.adminapi.event;
...
import ru.practicum.ewm.dtos.event.AdminUpdateEventRequest;
import ru.practicum.ewm.dtos.event.EventState;
